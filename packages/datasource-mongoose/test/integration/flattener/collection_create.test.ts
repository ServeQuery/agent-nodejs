...
import { ConditionTreeLeaf, Filter } from '@servequery/datasource-toolkit';
...
describe('Complex flattening', () => {
  ...
  /** @see https://community.servequery.com/t/bug-report-with-smart-models-on-node-js-agent/6480/6 */
