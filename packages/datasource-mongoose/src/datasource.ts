import { BaseDataSource, Logger } from '@servequery/datasource-toolkit';
  ...
  constructor(connection: Connection, options: MongooseOptions = {}, logger: Logger = null) {
    ...
    if (options && !options.flattenMode) {
      logger?.(
        ...
        'https://docs.servequery.com/developer-guide-agents-nodejs/data-sources/provided-data-sources/mongoose', // eslint-disable-line max-len
      );
    }
