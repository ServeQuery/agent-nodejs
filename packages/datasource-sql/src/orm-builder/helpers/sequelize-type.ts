...
export default class SequelizeTypeFactory {
   ...
   *
   * @see https://community.servequery.com/t/postgresql-enum-type-does-not-exist-error-wrong-enum-type-name/5931
  ...
  private static makeCustomEnumType(
    ...
    const Type = class extends DataTypes.ABSTRACT {
      // Markers to tell @servequery/datasource-sequelize to consider this type as an enum
      // when transforming sequelize models to servequery collections.
