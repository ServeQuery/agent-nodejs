...
const presignedPost = {
  url: 'https://s3.eu-west-3.amazonaws.com/servequery-platform-cloud-customization-test',
  fields: {
    bucket: 'servequery-platform-cloud-customization-test',
...
export const environmentVariables = {
  SERVEQUERY_AUTH_TOKEN: 'servequery-auth-token',
  SERVEQUERY_SERVER_URL: 'https://api.servequery.com',
  SERVEQUERY_SUBSCRIPTION_URL: 'wss://api.servequery.com/subscriptions',
  SERVEQUERY_ENV_SECRET: '63f51525814bdfec9dd99690a656757e251770c34549c5f383d909f5cce41eb9',
};
