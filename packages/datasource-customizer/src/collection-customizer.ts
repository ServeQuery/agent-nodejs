...
> {
   ...
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/plugins Documentation Link}
   * @example
   * import { createFileField } from '@servequery/plugin-s3';
   *
   ...
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/fields/import-rename-delete#moving-fields Documentation Link}
   * @example
   ...
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/fields/import-rename-delete#renaming-and-removing-fields Documentation Link}
   * @example
   ...
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/actions Documentation Link}
   * @example
   * .addAction('is live', {
   *    scope: 'Single',
   ...
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/charts Documentation Link}
   * @example
   ...
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/fields/computed Documentation Link}
   * @example
   * .addField('fullName', {
   *    columnType: 'String',
  ...
  addField: {
    ...
    return this.pushCustomization(async (logger: Logger) => {
      ...
      if (!definition.dependencies) {
        logger(
          'Error',
          `Computed field '${this.stack.validation.getCollection(this.name).name
   ...
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/fields/validation Documentation Link}
   * @example
   ...
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/hooks Documentation Link}
   * @example
   ...
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/relationships/single-record#many-to-one-relations Documentation Link}
   * @example
   ...
   * @param foreignCollection name of the targeted collection
   * @param options extra information about the relation
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/relationships/multiple-records#one-to-many-relations Documentation Link}
   * @example
   ...
   * @param foreignCollection name of the targeted collection
   * @param options extra information about the relation
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/relationships/single-record#one-to-one-relations Documentation Link}
   * @example
   ...
   * @param options extra information about the relation
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/relationships/multiple-records#many-to-many-relations Documentation Link}
   * @example
   ...
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/relationships/multiple-records#external-relations Documentation Link}
   * @example
   ...
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/segments Documentation Link}
   * @example
   * .addSegment(
   ...
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/fields/sort#disabling-sort Documentation Link}
   * @example
   ...
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/fields/sort#emulation Documentation Link}
   * @example
   ...
   * @see @{@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/fields/sort Documentation Link}
   * @example
   * .replaceFieldSorting(
   *   'fullName',
   *   [
   ...
   * @param name the name of the field to enable emulation on
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/fields/filter#emulation Documentation Link}
   * @example
   ...
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/fields/filter Documentation Link}
   * @example
   ...
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/fields/filter#substitution Documentation Link}
   * @example
   ...
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/fields/write Documentation Link}
   * @example
   ...
   * @see {@link https://docs.servequery.com/developer-guide-agents-nodejs/agent-customization/search Documentation Link}
   * @example
