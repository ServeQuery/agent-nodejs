...
import type { DataSourceFactory, Logger } from '@servequery/datasource-toolkit';

import PublicationCollectionDataSourceDecorator from '@servequery/datasource-customizer/dist/decorators/publication/datasource';
...
function createReplicaDataSource(rawOptions: ReplicaDataSourceOptions): DataSourceFactory {
  ...
  rawOptions.cacheNamespace ??= 'servequery';
