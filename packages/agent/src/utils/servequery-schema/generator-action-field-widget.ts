...
import {
  ServeQueryServerActionField,
  ServeQueryServerActionFieldAddressAutocompleteOptions,
  ServeQueryServerActionFieldCheckboxGroupOptions,
  ServeQueryServerActionFieldCheckboxOptions,
  ServeQueryServerActionFieldColorPickerOptions,
  ServeQueryServerActionFieldCurrencyInputOptions,
  ServeQueryServerActionFieldDatePickerInputOptions,
  ServeQueryServerActionFieldDropdownOptions,
  ServeQueryServerActionFieldFilePickerOptions,
  ServeQueryServerActionFieldJsonEditorOptions,
  ServeQueryServerActionFieldNumberInputListOptions,
  ServeQueryServerActionFieldNumberInputOptions,
  ServeQueryServerActionFieldRadioButtonOptions,
  ServeQueryServerActionFieldRichTextOptions,
  ServeQueryServerActionFieldTextAreaOptions,
  ServeQueryServerActionFieldTextInputListOptions,
  ServeQueryServerActionFieldTextInputOptions,
  ServeQueryServerActionFieldTimePickerOptions,
  ServeQueryServerActionFieldUserDropdown,
} from '@servequery/servequery-client';

import ActionFields from './action-fields';

export default class GeneratorActionFieldWidget {
  static buildWidgetOptions(field: ActionField): ServeQueryServerActionField['widgetEdit'] | undefined {
  ...
  private static buildDropdownWidgetEdit(field: ActionFieldDropdownAll) {
    return {
      ...
      | ServeQueryServerActionFieldDropdownOptions<number>;
  }
  ...
  private static buildRadioGroupWidgetEdit(
    ...
    | ServeQueryServerActionFieldRadioButtonOptions<number> {
    return {
      name: 'radio button',
      parameters: {
        static: {
  ...
  private static buildCheckboxGroupWidgetEdit(
    ...
    | ServeQueryServerActionFieldCheckboxGroupOptions<string>
    | ServeQueryServerActionFieldCheckboxGroupOptions<number> {
    return {
      name: 'checkboxes',
      parameters: {
        static: {
  ...
  private static buildCheckboxWidgetEdit(): ServeQueryServerActionFieldCheckboxOptions {
    return {
      name: 'boolean editor',
      parameters: {},
    };
  ...
  private static buildTimePickerWidgetEdit(): ServeQueryServerActionFieldTimePickerOptions {
    return {
      name: 'time editor',
      parameters: {},
    };
  ...
  private static buildJsonEditorWidgetEdit(): ServeQueryServerActionFieldJsonEditorOptions {
    return {
