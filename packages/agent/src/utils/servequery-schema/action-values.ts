import { ActionField, CompositeId, DataSource, File } from '@servequery/datasource-toolkit';
 ...
 */
export default class ServeQueryValueConverter {
  /**
  ...
  static valueToServeQuery(field: ActionField, value: unknown): unknown {
