import { IpWhitelistConfiguration } from '@servequery/servequery-client';
import Router from '@koa/router';
import IpUtil from 'servequery-ip-utils';
...
export default class IpWhitelist extends BaseRoute {
  ...
  override async bootstrap(): Promise<void> {
    this.configuration = await this.options.servequeryAdminClient.getIpWhitelistConfiguration();
  }
