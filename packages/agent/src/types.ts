import { CompositeId, Logger, LoggerLevel } from '@servequery/datasource-toolkit';
import { ServeQueryClient } from '@servequery/servequery-client';
import { IncomingMessage, ServerResponse } from 'http';

/** Options to configure behavior of an agent's servequery driver */
export type AgentOptions = {
  ...
  servequeryAdminClient?: ServeQueryClient;
  experimental?: {
