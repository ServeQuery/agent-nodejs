import { CollectionCustomizer } from '@servequery/datasource-customizer';
import { ModelCustomizationType } from '@servequery/servequery-client/src/model-customizations/types';
...
import { servequeryAdminHttpDriverOptions } from '../../__factories__';
  ...
  describe('addCustomizations', () => {
    ...
    describe('when experimental.webhookCustomActions is defined', () => {
      it('should add all webhook action customizations', async () => {
        const options = servequeryAdminHttpDriverOptions.build({
          experimental: {
        ...
        (
          options.servequeryAdminClient.modelCustomizationService.getConfiguration as jest.Mock
