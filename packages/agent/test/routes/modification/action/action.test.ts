...
describe('ActionRoute', () => {
  ...
  beforeEach(() => {
    jest.resetAllMocks();
    (
      options.servequeryAdminClient.permissionService.canTriggerCustomAction as jest.Mock
    ).mockResolvedValue(true);
    (
      options.servequeryAdminClient.permissionService.canApproveCustomAction as jest.Mock
    ).mockResolvedValue(true);
    (
      options.servequeryAdminClient.permissionService.canRequestCustomActionParameters as jest.Mock
    ).mockResolvedValue(true);
  });
  ...
  describe('middleware CustomActionApprovalRequestData', () => {
    ...
    describe('when the request contains requester_id', () => {
      test('it should reject with UnprocessableError (prevent forged request)', async () => {
        ...
        const verifySignedActionParameters = options.servequeryAdminClient
  ...
  describe('with a single action used from list-view, detail-view & summary', () => {
    ...
    test('handleExecute should throw an error if the user is not authorized', async () => {
      ...
      const canTriggerActions = options.servequeryAdminClient.permissionService
    ...
    test('handleHook should throw an error if the user is not authorized', async () => {
      ...
      const canRequestCustomActionParameters = options.servequeryAdminClient.permissionService
