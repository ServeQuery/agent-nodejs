import { Collection } from '@servequery/datasource-toolkit';

import SchemaGeneratorActions from '../../../src/utils/servequery-schema/generator-actions';
...
describe('SchemaGeneratorActions', () => {
  describe('Without form', () => {
    ...
    test('should generate schema correctly', async () => {
      ...
      expect(schema).toStrictEqual({
        ...
        baseUrl: null,
        download: false,
        endpoint: '/servequery/_actions/books/0/send-email',
        fields: [],
        httpMethod: 'POST',
        redirect: null,
        type: 'single',
  ...
  describe('With no hooks', () => {
    ...
    test('should generate schema correctly', async () => {
      ...
      expect(schema).toHaveProperty('endpoint', '/servequery/_actions/books/0/send-email');
    });
  });
