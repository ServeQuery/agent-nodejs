...
import { ServeQueryAuthServiceInterface, ServeQueryClientOptionsWithDefaults } from '../types';
import ServerUtils from '../utils/server';

export default class AuthService implements ServeQueryAuthServiceInterface {
  protected client: BaseClient;

  constructor(private options: ServeQueryClientOptionsWithDefaults) { }
  ...
  public async getUserInfo(renderingId: number, accessToken: string): Promise<UserInfo> {
    ...
    const headers = { 'servequery-token': accessToken };
