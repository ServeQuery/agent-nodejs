...
describe('RenderingPermissionService', () => {
  ...
  function setup() {
    ...
    const options = {
      servequeryServerUrl: 'https://api.dev',
      envSecret: 'secret',
      isProduction: true,
    ...
    const serverInterface = factories.servequeryAdminServerInterface.build();
